export function Usable_material(){
    ...
    <div class="container col-8" style="margin-top: 15vh; margin-bottom: 15vh">
        <div class="row g-0">
            <div class="col-lg-6">
                <img src="/assets/img/PLASTICO.jpg" alt="Descripción de la imagen" class="img-fluid divided-info-img">
            </div>
            <div class="col-lg-6 divided-info-right">
                <div>
                    <div style="text-align:end; padding-left:15px">
                        <div class="my-1">
                            <span class="" style="font-size:2.5rem; color:#ffffff; background-color:#3f1978; border-radius:50px; padding-left: 10px; padding-right: 10px">PLÁSTICO</span>
                        </div>
                        <p>El proceso de reciclaje de plásticos consta de varias etapas. En primer lugar, se depositan los
        ...
        <div class="row g-0" style="margin-top: 15vh">
            <div class="col-lg-6 divided-info-left" >
                <div>
                    <div style="padding-right:15px">
                        <div>
                            <span style="font-size:2.5rem; color:#ffffff; background-color:#3f1978; border-radius:50px; padding-left: 10px; padding-right: 10px">METALES</span>
                        </div>
            ...
            <div class="col-lg-6">
                <img src="/assets/img/METALES.jpg" alt="Descripción de la imagen" class="img-fluid divided-info-img">
            </div>
        </div>
        <div class="row g-0" style="margin-top: 15vh">
            <div class="col-lg-6">
                <img src="/assets/img/VIDRIO.jpg" alt="Descripción de la imagen" class="img-fluid divided-info-img">
            </div>
            <div class="col-lg-6 divided-info-right" >
                <div>
                    <div style="text-align:end; padding-left:15px">
                        <div class="my-1">
                            <span class="" style="font-size:2.5rem; color:#ffffff; background-color:#3f1978; border-radius:50px; padding-left: 10px; padding-right: 10px">VÍDRIO</span>
                        </div>
        ...
        <div class="row g-0" style="margin-top: 15vh">
            <div class="col-lg-6 divided-info-left" >
                <div>
                    <div style="padding-right:15px">
                        <div>
                            <span style="font-size:2.5rem; color:#ffffff; background-color:#3f1978; border-radius:50px; padding-left: 10px; padding-right: 10px">MADERA</span>
                        </div>
            ...
            <div class="col-lg-6">
                <img src="/assets/img/MADERA.jpg" alt="Descripción de la imagen" class="img-fluid divided-info-img">
            </div>
        </div>
        <div class="row g-0" style="margin-top: 15vh">
            <div class="col-lg-6">
                <img src="/assets/img/TEXTIL.jpg" alt="Descripción de la imagen" class="img-fluid divided-info-img">
            </div>
            <div class="col-lg-6 divided-info-right" >
                <div>
                    <div style="text-align:end; padding-left:15px">
                        <div class="my-1">
                            <span class="" style="font-size:2.5rem; color:#ffffff; background-color:#3f1978; border-radius:50px; padding-left: 10px; padding-right: 10px">TEXTIL</span>
                        </div>
